    ...
    <div class="flex w-40 shrink-0 flex-col gap-0.5 border-r border-border/50 p-1.5">
      ...
      <div class="mt-1 flex flex-col gap-1.5 border-t border-border/40 px-1 pt-2">
        ...
        <div class="flex items-center gap-1">
          ...
          <input
            class="h-6 w-9 min-w-0 rounded-lg border border-border bg-input/30 text-center font-mono text-ui-xs tabular-nums outline-none focus:border-ring focus:ring-1 focus:ring-ring"
            inputmode="numeric"
            value={lastN}
