                      ...
                      {:else if field.isBoolean}
                        <div class="relative">
                          <select
                            ...
                            disabled={savingFields[field.colIdx]}
                            class="w-full appearance-none rounded border border-border bg-muted/20 px-2.5 py-1.5 pr-7 font-mono text-ui-xs text-foreground focus:border-ring focus:ring-1 focus:ring-ring focus:outline-none disabled:opacity-50"
                            onchange={async (e) => {
