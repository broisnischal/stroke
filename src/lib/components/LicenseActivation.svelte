...
<div class="flex flex-col gap-3 {naked ? '' : compact ? 'p-5' : 'p-6'}">
  ...
  <div class="relative">
    ...
    <input
      ...
      class="h-11 w-full rounded-lg border-2 border-border bg-muted/25 pl-10 pr-3 font-mono text-ui-sm tracking-wider text-foreground outline-none transition-[border-color,box-shadow] placeholder:font-sans placeholder:tracking-normal placeholder:text-muted-foreground/30 hover:border-border focus:border-ring focus:ring-1 focus:ring-ring focus:bg-muted/10 focus:border-ring focus:ring-1 focus:ring-ring disabled:opacity-50"
    />
  </div>
