...
export const idGenerators = {
  id: 'id-generators',
  name: 'ID Generators',
  description: 'Mint identifiers: UUID v7 / v4, ULID, CUID, nanoid, hex tokens.',
  kind: 'generators',
  generators: [
    { id: 'uuidv7', label: 'UUID v7', hint: 'Time-ordered, index-friendly', group: 'IDs', generate: uuidv7 },
    { id: 'uuidv4', label: 'UUID v4', hint: 'Fully random', group: 'IDs', generate: uuidv4 },
    { id: 'ulid', label: 'ULID', hint: 'Sortable, 26 chars', group: 'IDs', generate: ulid },
    { id: 'cuid', label: 'CUID', hint: 'Short, collision-resistant', group: 'IDs', generate: cuid },
    { id: 'nanoid', label: 'nanoid', hint: '21-char URL-safe', group: 'IDs', generate: () => nanoid() },
    { id: 'nanoid-short', label: 'Short ID', hint: '8-char nanoid', group: 'IDs', generate: () => nanoid(8) },
    { id: 'hex-token', label: 'Hex token', hint: '32 hex chars', group: 'IDs', generate: () => hex(16) },
  ],
}
